<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="insert_graduation_plan_page.aspx.cs" Inherits="Milestone3.insert_graduation_plan_page" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Graduation Plan Entry</title>
     <style type="text/css">
        body {
...
<body>
    <div class="form-container">
        ...
        <h2 style="text-align:center; color:#0366d6">Graduation Plan Entry</h2>
        <form id="form1" runat="server">
            ...
            <label for="SemesterCreditHoursTextBox">Semester Credit Hours:</label>
            <asp:TextBox ID="SemesterCreditHoursTextBox" runat="server"></asp:TextBox>
            ...
            <asp:Button ID="InsertButton" CssClass="submit-button" runat="server" Text="Insert" OnClick="InsertButton_Click" />
        </form>
    </div>
</body>
</html>
