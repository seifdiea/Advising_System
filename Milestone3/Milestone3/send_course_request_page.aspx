<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="send_course_request_page.aspx.cs" Inherits="Milestone3.send_course_request_page" %>
...
<body>
   <form id="form1" runat="server">
    <div>
        ...
        <asp:Button ID="sendCourse" runat="server" Text="Send Request" OnClick="sendCourse_Click" Width="100px" />
