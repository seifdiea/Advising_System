<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_advising_students.aspx.cs" Inherits="Milestone3.view_advising_students" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>View Advising Students</title>
    <style type="text/css">
    .grid-container {
       width: 100%;
       text-align: center;
...
<body>
    ...
    <button class="submit-button" onclick="window.location.href='Advisor_data.aspx';">Back to Advisor Data Page</button>
     <form id="form1" runat="server">
        <asp:GridView ID="StudentsGridView" runat="server" AutoGenerateColumns="True"
