<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="firstMakeup_registration.aspx.cs" Inherits="Milestone3.firstMakeup_registration" %>
...
<body>
    ...
    <div>
        ...
        <asp:Button ID="RegisterCourse" runat="server" Text="Register" OnClick="registerFirstMakeup_Click" Width="100px" />
